...
* **Tool-Based Skills Engine**: Load and unload specialized personas and capability instructions on-demand via the `load_skill` tool without polluting the persistent context window.
