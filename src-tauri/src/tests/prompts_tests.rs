...
mod tests {
    ...
    fn test_get_default_system_prompt_with_memory() {
        ...
        let prompt = get_default_system_prompt_with_date(Some(memory), None, None, None, None, None, fixed_date());
    ...
    fn test_get_default_system_prompt_with_rag() {
        ...
        let prompt = get_default_system_prompt_with_date(None, Some(rag), None, None, None, None, fixed_date());
    ...
    fn test_get_default_system_prompt_with_both() {
        ...
        let prompt = get_default_system_prompt_with_date(Some(memory), Some(rag), None, None, None, None, fixed_date());
        assert!(prompt.contains(memory));
        assert!(prompt.contains(rag));
    }
    ...
    fn test_prompt_with_peer_card() {
        let card = "## User Card\n\n- Lives in SF\n- Prefers Rust\n";
        let prompt = get_default_system_prompt_with_date(None, None, Some(card), None, None, None, fixed_date());
    ...
    fn test_prompt_with_peer_representation() {
        ...
        let prompt = get_default_system_prompt_with_date(None, None, None, Some(rep), None, None, fixed_date());
    ...
    fn test_prompt_with_all_context() {
        ...
        let prompt = get_default_system_prompt_with_date(Some(memory), Some(rag), Some(card), Some(rep), None, None, fixed_date());
        assert!(prompt.contains(memory));
        assert!(prompt.contains(rag));
        assert!(prompt.contains("Lives in SF"));
